...
const projects = [
  ...
  {
    title: "Enterprise Revenue & Billing Analytics Platform",
    role: "Full-Stack Developer",
    overview:
      "A full-stack analytics dashboard for visualizing revenue, billing, and client-performance data across UAE government entities and sectors, with a fully customizable drag-and-drop widget layout. Deployed on Windows Server / IIS.",
    contributions: [
      "Built a drag-and-drop, snap-to-grid widget dashboard (dnd-kit) with resizable widgets and savable per-user layout presets",
      "Developed a Recharts visualization suite — stacked bar, pie, radar, brushable time-series, and an interactive UAE emirate map",
      "Created a type-safe Next.js route-handler API layer proxying a .NET / SQL Server backend, with 2FA + biometric (face-liveness, OCR) authentication",
      "Added PDF/image report export (jsPDF + html2canvas), PWA support, and multi-language localization",
    ],
    results: [
      { metric: "20+", label: "Data Widgets" },
      { metric: "2FA", label: "Biometric Auth" },
      { metric: "PWA", label: "i18n & PDF Export" },
    ],
    tech: ["Next.js 16", "React 19", "TypeScript", "Tailwind v4", "Recharts"],
