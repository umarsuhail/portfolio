      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <div className="transition ease-in-out delay-150 text-violet-700 hover:-translate-y-1 hover:scale-125 hover:shadow-md  shadow	 font-extrabold hover:text-fuchsia-600 duration-300">
            <a href="/" className='w-full animate-pulse ease-in delay-200 duration-300'>Umar Suhail P M</a>


          </div>
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=umarsuhail112@gmail.com" target="_blank" className='cursor-pointer hover:text-yellow-300 text-xs font-extralight mx-2 text-white opacity-75'>umarsuhail112@gmail.com</a>
